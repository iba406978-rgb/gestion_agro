        ...
        <>
            <header>
                <nav
                    ...
                    className="group fixed z-20 w-full border-b border-dashed bg-[#2E7D32] text-white backdrop-blur md:relative dark:bg-zinc-950/50 lg:dark:bg-transparent">
                        ...
                        <div className="lg:flex lg:items-center lg:gap-12">
                            <div className="relative z-10 mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                <Link
                                    ...
                                    <span className="text-sm">Dalal ak diame si SenAgro</span>
                                    <span className="bg-(--color-border) block h-4 w-px"></span>

                                    <ArrowRight className="size-4" />
                                </Link>

                                <h1 className="mt-10 text-balance text-4xl font-bold md:text-5xl xl:text-5xl">Bienvenu à SenAgro</h1>
                                <p className="mt-8">SenAgro est un service de gestion agricole. </p>
                                        ...
                                        <div className="bg-background has-[input:focus]:ring-muted relative grid grid-cols-[1fr_auto] items-center rounded-[1rem] border pr-1 shadow shadow-zinc-950/5 has-[input:focus]:ring-2">
                                            ...
                                            <div className="md:pr-1.5 lg:pr-0">
                                                <Button
                                                    aria-label="submit"
                                                >
                                                    <span className="hidden md:block">Entrer</span>
                                                    <SendHorizonal
